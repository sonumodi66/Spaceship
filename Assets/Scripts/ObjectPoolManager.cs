...
public class GameObjectContainer
{
    ...
    public List<IPoolablePrevious> PoolingEnabledComponents;
    public int Cycles;
...
public class ObjectPoolManager : MonoBehaviour
{
    ...
    {
        foreach (var item in objectPoolsList)
        {
    ...
    private GameObjectContainer CreatePooledObject(ObjectPool pool)
    {
        ...
        var container = new GameObjectContainer
        {
            ...
            Pool = pool,
            PoolingEnabledComponents = obj.GetComponents<IPoolablePrevious>().ToList(),    
        };
...
public interface IPoolablePrevious
{
    void Spawn();
    void Despawn();
}
